 ...
 */
class Fusion extends Fusion_Base
{
	const VERSION = '1.0.0';
	const SLUG    = 'fusion';
	...
	protected function __construct() {
		 ...
		 */
		add_action( 'template_include', 'Fusion_Wrapper::wrap' );
	...
	protected function setup_menus() {
		register_nav_menus( array(
			'primary' => esc_html__( 'Primary Menu', 'fusion' ),
			'top'     => esc_html__( 'Top Menu', 'fusion' )
		) );
	}
	...
	protected function setup_sidebars() {
		register_sidebar( array(
			'name'          => esc_html__( 'Primary Sidebar', 'fusion' ),
			'id'            => 'sidebar-primary',
			'description'   => '',
		...
		// Header Widgets
		register_sidebar( array(
			'name'          => esc_html__( 'Header Sidebar', 'fusion' ),
			'id'            => 'header-widgets',
			'description'   => '',
			'before_widget' => '<div id="%1$s" class="widget %2$s">',
			'after_widget'  => '</div>',
		...
		// Footer Sidebars
		register_sidebar( array(
			'name'          => esc_html__( 'Footer Sidebar #1', 'fusion' ),
			'id'            => 'footer-1',
			'description'   => '',
			'before_widget' => '<div id="%1$s" class="widget %2$s">',
			'after_widget'  => '</div>',
		...
		register_sidebar( array(
			'name'          => esc_html__( 'Footer Sidebar #2', 'fusion' ),
			'id'            => 'footer-2',
			'description'   => '',
			'before_widget' => '<div id="%1$s" class="widget %2$s">',
			'after_widget'  => '</div>',
		...
		register_sidebar( array(
			'name'          => esc_html__( 'Footer Sidebar #3', 'fusion' ),
			'id'            => 'footer-3',
			'description'   => '',
			'before_widget' => '<div id="%1$s" class="widget %2$s">',
			'after_widget'  => '</div>',
		...
		register_sidebar( array(
			'name'          => esc_html__( 'Footer Sidebar #4', 'fusion' ),
			'id'            => 'footer-4',
			'description'   => '',
			'before_widget' => '<div id="%1$s" class="widget %2$s">',
			'after_widget'  => '</div>',
		...
		register_sidebar( array(
			'name'          => esc_html__( 'Content Bottom #1', 'fusion' ),
			'id'            => 'content-bottom-1',
			'description'   => '',
			'before_widget' => '<div id="%1$s" class="widget %2$s">',
			'after_widget'  => '</div>',
		...
		register_sidebar( array(
			'name'          => esc_html__( 'Content Bottom #2', 'fusion' ),
			'id'            => 'content-bottom-2',
			'description'   => '',
			'before_widget' => '<div id="%1$s" class="widget %2$s">',
			'after_widget'  => '</div>',
		...
		register_sidebar( array(
			'name'          => esc_html__( 'Content Bottom #3', 'fusion' ),
			'id'            => 'content-bottom-3',
			'description'   => '',
			'before_widget' => '<div id="%1$s" class="widget %2$s">',
			'after_widget'  => '</div>',
		...
		register_sidebar( array(
			'name'          => esc_html__( 'Content Bottom #4', 'fusion' ),
			'id'            => 'content-bottom-4',
			'description'   => '',
			'before_widget' => '<div id="%1$s" class="widget %2$s">',
			'after_widget'  => '</div>',
	...
	protected function setup_features() {
		 ...
		 */
		Fusion_ThemeCustomize::instance();

		/**
		 * Initialize custom sidebars manager
		 */
		Fusion_Sidebars::instance();
		
		/**
		 * Initialize theme breadcrumb
		 */
		Fusion_Breadcrumb::instance();	

		/**
		 * Initialize search feature
		 */
		Fusion_Search::instance();

		/**
		 * Initialize support for WooCommerce
		 */
		Fusion_Woocommerce::instance();

		/**
		 * Initialize support for Projects
		 */
		Fusion_Projects::instance();
	}
}
