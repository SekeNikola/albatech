...
class Typography extends \OptionsPlus\Options\Control
{
	...
	public function __construct( $id, $args = array() ) {
		...
		$this->titles = array(
			'100'        => esc_html__( 'Thin 100', 'fusion' ),
			'100italic'  => esc_html__( 'Thin 100 italic', 'fusion' ),
			'200'        => esc_html__( 'Extra-light 200', 'fusion' ),
			'200italic'  => esc_html__( 'Extra-light 200 italic', 'fusion' ),
			'300'        => esc_html__( 'Light 300', 'fusion' ),
			'300italic'  => esc_html__( 'Light 300 italic', 'fusion' ),
			'400'        => esc_html__( 'Normal 400', 'fusion' ),
			'400italic'  => esc_html__( 'Normal 400 italic', 'fusion' ),
			'500'        => esc_html__( 'Medium 500', 'fusion' ),
			'500italic'  => esc_html__( 'Medium 500 italic', 'fusion' ),
			'600'        => esc_html__( 'Semi-bold 600', 'fusion' ),
			'600italic'  => esc_html__( 'Semi-bold 600 italic', 'fusion' ),
			'700'        => esc_html__( 'Bold 700', 'fusion' ),
			'700italic'  => esc_html__( 'Bold 700 italic', 'fusion' ),
			'800'        => esc_html__( 'Extra-bold 800', 'fusion' ),
			'800italic'  => esc_html__( 'Extra-bold 800 italic', 'fusion' ),
			'900'        => esc_html__( 'Ultra-bold 900', 'fusion' ),
			'900itallic' => esc_html__( 'Ultra-bold 900 italic', 'fusion' )
		);
	}
			...
			<div class="options-control-inputs">
				...
				<div class="options-control-chosen typography-font">
					<div class="options-control-title">
						<label for="<?php echo esc_attr( $name ) ?>-family"><?php esc_html_e( 'Font Family', 'fusion' ) ?></label>
					</div>
					<div class="options-control-inputs">
						<select name="op-options[<?php echo esc_attr( $this->id ) ?>][family]" id="<?php echo esc_attr( $name ) ?>-family">
							<optgroup label="<?php echo esc_attr( 'System Fonts', 'fusion' ) ?>">
							...
							<optgroup label="<?php echo esc_attr( 'Google Fonts', 'fusion' ) ?>">
				...
				<div class="typography-size">
					<div class="options-control-title">
						<label for="<?php echo esc_attr( $name ) ?>-size"><?php esc_html_e( 'Font Size (px)', 'fusion' ) ?></label>
					</div>
					<div class="options-control-inputs">
				...
				<div class="options-control-dropdown typography-style">
					<div class="options-control-title">
						<label><?php esc_html_e( 'Font Weight & Style', 'fusion' ) ?></label>
					</div>
					<div class="options-control-inputs">
						<label>
				...
				<div class="options-control-color-picker typography-color">
					<div class="options-control-title">
						<label><?php esc_html_e( 'Font Color', 'fusion' ) ?></label>
					</div>
					<div class="options-control-inputs">
