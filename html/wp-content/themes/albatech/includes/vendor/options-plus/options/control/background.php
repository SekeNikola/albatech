			...
			<div class="options-control-inputs">
				...
				<div class="background-custom">
					<div class="options-control-media-picker background-image">
						<div class="options-control-title"><?php esc_html_e( 'Background Image', 'fusion' ) ?></div>
						<div class="options-control-inputs">
							<div class="upload-dropzone">
								<span class="upload-message">
									<?php esc_html_e( 'Drop a file here or', 'fusion' ) ?>
									<a href="#" class="browse-media"><?php esc_html_e( 'select a file', 'fusion' ) ?></a>
									<a href="#" class="upload"></a>
								</span>
								<span class="upload-preview"></span>
							</div>
							<a href="#" class="button remove"><?php esc_html_e( 'Remove', 'fusion' ) ?></a>
						</div>
					...
					<div class="options-control-radio-images background-repeat">
						<div class="options-control-title"><?php esc_html_e( 'Background Repeat', 'fusion' ) ?></div>
						<div class="options-control-inputs">
							<label class="background-no-repeat">
								...
								<span data-title="<?php echo esc_attr( 'No Repeat', 'fusion' ) ?>"><?php esc_html_e( 'No Repeat', 'fusion' ) ?></span>
							</label>
							<label class="background-repeat-x">
								...
								<span data-title="<?php echo esc_attr( 'Repeat X', 'fusion' ) ?>"><?php esc_html_e( 'Repeat X', 'fusion' ) ?></span>
							</label>
							<label class="background-repeat-y">
								...
								<span data-title="<?php echo esc_attr( 'Repeat Y', 'fusion' ) ?>"><?php esc_html_e( 'Repeat Y', 'fusion' ) ?></span>
							</label>
							<label class="background-repeat-all">
								...
								<span data-title="<?php echo esc_attr( 'Repeat All', 'fusion' ) ?>"><?php esc_html_e( 'Repeat All', 'fusion' ) ?></span>
							</label>
						</div>
					</div>

					<div class="options-control-radio-images background-position">
						<div class="options-control-title"><?php esc_html_e( 'Background Position', 'fusion' ) ?></div>
						<div class="options-control-inputs">
							<label class="background-top-left">
								...
								<span data-title="<?php echo esc_attr( 'Top Left', 'fusion' ) ?>"><?php esc_html_e( 'Top Left', 'fusion' ) ?></span>
							</label>
							<label class="background-top-center">
								...
								<span data-title="<?php echo esc_attr( 'Top Center', 'fusion' ) ?>"><?php esc_html_e( 'Top Center', 'fusion' ) ?></span>
							</label>
							<label class="background-top-right">
								...
								<span data-title="<?php echo esc_attr( 'Top Right', 'fusion' ) ?>"><?php esc_html_e( 'Top Right', 'fusion' ) ?></span>
							</label>
							...
							<label class="background-middle-left">
								...
								<span data-title="<?php echo esc_attr( 'Middle Left', 'fusion' ) ?>"><?php esc_html_e( 'Middle Left', 'fusion' ) ?></span>
							</label>
							<label class="background-middle-center">
								...
								<span data-title="<?php echo esc_attr( 'Middle Center', 'fusion' ) ?>"><?php esc_html_e( 'Middle Center', 'fusion' ) ?></span>
							</label>
							<label class="background-middle-right">
								...
								<span data-title="<?php echo esc_attr( 'Middle Right', 'fusion' ) ?>"><?php esc_html_e( 'Middle Right', 'fusion' ) ?></span>
							</label>
							...
							<label class="background-bottom-left">
								...
								<span data-title="<?php echo esc_attr( 'Bottom Left', 'fusion' ) ?>"><?php esc_html_e( 'Bottom Left', 'fusion' ) ?></span>
							</label>
							<label class="background-bottom-center">
								...
								<span data-title="<?php echo esc_attr( 'Bottom Center', 'fusion' ) ?>"><?php esc_html_e( 'Bottom Center', 'fusion' ) ?></span>
							</label>
							<label class="background-bottom-right">
								...
								<span data-title="<?php echo esc_attr( 'Bottom Right', 'fusion' ) ?>"><?php esc_html_e( 'Bottom Right', 'fusion' ) ?></span>
							</label>
						</div>
					</div>

					<div class="options-control-radio-images background-style">
						<div class="options-control-title"><?php esc_html_e( 'Background Style', 'fusion' ) ?></div>
						<div class="options-control-inputs">
							<label class="background-fixed">
								...
								<span data-title="<?php echo esc_attr( 'Fixed', 'fusion' ) ?>"><?php esc_html_e( 'Fixed', 'fusion' ) ?></span>
							</label>
							<label class="background-scroll">
								...
								<span data-title="<?php echo esc_attr( 'Scroll', 'fusion' ) ?>"><?php esc_html_e( 'Scroll', 'fusion' ) ?></span>
							</label>
							<label class="background-cover">
								...
								<span data-title="<?php echo esc_attr( 'Cover', 'fusion' ) ?>"><?php esc_html_e( 'Cover', 'fusion' ) ?></span>
							</label>
						</div>
					</div>
				</div>
