...
if ( ! function_exists( 'fusion_options_plus_uri' ) ) {
	add_filter( 'op/directory_uri', 'fusion_options_plus_uri' );
	 ...
	 * @return  string
	 */
	function fusion_options_plus_uri( $uri ) {
...
if ( ! function_exists( 'fusion_options_plus_path' ) ) {
	add_filter( 'op/directory_path', 'fusion_options_plus_path' );
	 ...
	 * @return  string
	 */
	function fusion_options_plus_path( $path ) {
