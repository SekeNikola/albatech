...
if ( ! function_exists( 'fusion_post_title' ) ) {
	/**
	 * Display the post title
	 * 
	 * @return  void
	 */
	function fusion_post_title() {
...
if ( ! function_exists( 'fusion_post_meta' ) ) {
	/**
	 * Display the post meta
	 * 
	 * @return  void
	 */
	function fusion_post_meta() {
		...
		?>
			...
			<div class="entry-meta">
				<span><?php esc_html_e( 'By', 'fusion' ) ?></span>
				...
				<span class="entry-categories">
					<?php the_category( _x( ', ', 'Used between list items, there is a space after the comma.', 'fusion' ) ); ?>
				</span>
				...
				<?php if ( ! post_password_required() && ( comments_open() || get_comments_number() ) ) : ?>
					...
					<?php else: ?>
						...
						<span class="entry-comments-link">
							<?php comments_popup_link( esc_html__( '0', 'fusion' ), esc_html__( '1', 'fusion' ), esc_html__( '%', 'fusion' ) ); ?>
						</span>

					<?php endif ?>
				<?php endif ?>
				
				<?php edit_post_link( esc_html__( '(Edit)', 'fusion' ), '<span class="edit-link">', '</span>' ); ?>
			</div>
...
if ( ! function_exists( 'fusion_post_content' ) ) {
	/**
	 * Display the post content
	 * 
	 * @return  void
	 */
	function fusion_post_content() {
