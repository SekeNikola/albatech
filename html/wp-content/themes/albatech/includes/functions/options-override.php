...
add_action( 'after_switch_theme', 'fusion_migrate_theme_options' );

// Override theme options for specific page
add_filter( 'op/prepare_options', 'fusion_override_theme_options' );
 ...
 * @return  void
 */
function fusion_migrate_theme_options() {
	$default_options = fusion_customize_default_options();
 ...
 * @return  array
 */
function fusion_customize_default_options() {
	return array(
		'data_version'  => '1.0',
		'gotop_enabed'  => true,
		'social_links'  => array(
 ...
 * @return  array
 */
function fusion_override_theme_options( $options ) {
	global $post;
