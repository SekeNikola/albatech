	...
	<div class="entry-wrapper">
		...
		<?php if ( op_current_post_type() != 'page' ): ?>
			...
			<header class="entry-header">
				...
				<?php fusion_post_title() ?>
				<?php fusion_post_meta() ?>
			</header>
		...
		<div class="entry-content" itemprop="text">
			...
			fusion_post_content();
			wp_link_pages( array(
				'before'      => '<div class="page-links"><span class="page-links-title">' . esc_html__( 'Pages:', 'fusion' ) . '</span>',
				'after'       => '</div>',
				'link_before' => '<span>',
				'link_after'  => '</span>',
			) );
		...
		<?php if ( is_single() && get_the_tags() ): ?>
			<div class="entry-footer">
				<div class="entry-tags">
					<strong><?php esc_html_e( 'Tags', 'fusion' ) ?></strong>
					<?php the_tags( '', ' ' ); ?>
				</div>
			</div>
			<!-- /.entry-footer -->
