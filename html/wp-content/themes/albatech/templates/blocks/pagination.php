...
$links = paginate_links( array(
	...
	'prev_text' => esc_html__( '&larr; Previous', 'fusion' ),
	'next_text' => esc_html__( 'Next &rarr;', 'fusion' ),
) );
...
$next_link = get_next_posts_link( esc_html__( 'Next &rarr;', 'fusion' ) );
$prev_link = get_previous_posts_link( esc_html__( '&larr; Previous', 'fusion' ) );
$more_link = get_next_posts_link( esc_html__( 'Ostale novosti', 'fusion' ) );
